...
def diaganol_another_way_win(row, col, color):
...
def diaganol_different_way_win(row, col, color):
    if col < 3:
        return
    in_a_diaganol=0
    for col in reversed(range(0, col+1)):
        if board[row][col]==color:
            in_a_diaganol+=1
        else:
            in_a_diaganol=0
...
def diaganol_last_way_win(row, col, color):
    if col < 3:
        return
    in_a_diaganol=0
    for col in reversed(range(0, col+1)):
